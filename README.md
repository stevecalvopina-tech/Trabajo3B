...
# En los primeros análisis realizamos una comparación entre los archivos comprometidos y el impacto en las finanzas de las empresas afectadas, utilizamos un scatter con regresión y filtramos los ataques que no corrompieron ningún archivo y el resultado es una gráfica que muestra claramente como a mayor número de archivos corruptos el impacto economico fue mayor
# Para nuestro segundo análisis creamos una comparación entre la perdida económica de la empresa y la caída en el valor de las acciones como consecuencia del ataque, se muestra como el atauqe no solo provoca caída financiera inmediata sino que también una caída en la bolsa que creará impactos económicos a futuro
